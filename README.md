...
- [zebedeeio/zbd-mcp-server](https://github.com/zebedeeio/zbd-mcp-server) 📇 🏠 - Interact with ZBD's payment processing APIs for instant global payments with Bitcoin and Lightning 
